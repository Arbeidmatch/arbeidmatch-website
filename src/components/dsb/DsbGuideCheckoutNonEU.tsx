  ...
  return (
    <>
      <section className="bg-gradient-to-br from-[#3a250a] via-[#0a0f1e] to-[#0a0f1e] py-16 text-white md:py-20">
        <div className="mx-auto w-full max-w-content px-4 md:px-6">
          ...
          <p className="mt-4 max-w-3xl text-base text-white/85 md:text-lg">
            The complete guide to navigating the Norwegian DSB authorization process from outside the EU.
          </p>
          <p className="mt-5 inline-block rounded-lg border border-amber-300/35 bg-amber-200/10 px-4 py-3 text-sm font-semibold text-amber-100">
            6-12 months · Work visa required · Individual assessment
          </p>
        </div>
      </section>
      ...
      <section className="bg-surface py-14">
        <div className="mx-auto w-full max-w-content px-4 md:px-6">
          <div className="mx-auto max-w-3xl rounded-xl border border-amber-300/35 bg-white p-8 shadow-[0_10px_30px_rgba(13,27,42,0.08)]">
            <div className="rounded-lg border border-amber-300/45 bg-amber-100/20 px-4 py-3 text-sm text-amber-900">
              Important: This guide covers DSB authorization only. Your work visa must be arranged separately with
            ...
            <div className="mt-8 space-y-2 text-center">
              <Link href="/dsb-support/eu" className="block text-sm font-medium text-gold hover:text-gold-hover">
                EU/EEA citizen? See the EU guide →
              </Link>
              <button
                type="button"
