  ...
  return (
    ...
    >
      <motion.div
        ...
        className="relative w-[90vw] max-w-[440px] rounded-[20px] border border-[rgba(201,168,76,0.25)] px-8 py-10"
      ...
      >
        ...
        <h2 id="coming-soon-title" className="mt-4 text-center text-[22px] font-bold text-white">
          Coming Soon
        </h2>
        ...
        {status === "success" ? (
          <p className="mt-6 text-center text-[14px] text-white/[0.85]">
            <span className="mr-1 text-[#C9A84C]" aria-hidden>
              ✓
            </span>
            You are on the list. We will email you at {email} when this is ready.
          </p>
        ) : (
          <form onSubmit={submit} className="mt-6">
            <input
              ...
              className="w-full rounded-[8px] border border-white/[0.12] bg-white/[0.06] px-[14px] py-3 text-[13px] text-white placeholder:text-white/40"
            />
            ...
            <button
              ...
              className="mt-4 w-full rounded-[10px] py-3.5 text-[14px] font-bold text-[#0f1923] transition-opacity disabled:opacity-60"
