...
function priceBoxHtml(opts: {
  ...
  return `<div style="margin:20px 0;padding:24px;border-radius:12px;border:1px solid rgba(184,134,11,0.3);background:rgba(184,134,11,0.05);">
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="font-size:14px;line-height:1.7;color:#333;">
      <tr><td style="padding:6px 0;border-bottom:1px solid rgba(0,0,0,0.06);">Regular price</td><td style="padding:6px 0;border-bottom:1px solid rgba(0,0,0,0.06);text-align:right;">€${regular}</td></tr>
      <tr><td style="padding:6px 0;border-bottom:1px solid rgba(0,0,0,0.06);"><strong>Your price</strong></td><td style="padding:6px 0;border-bottom:1px solid rgba(0,0,0,0.06);text-align:right;"><strong>€${yourPrice}</strong></td></tr>
      <tr><td style="padding:6px 0;border-bottom:1px solid rgba(0,0,0,0.06);">You save</td><td style="padding:6px 0;border-bottom:1px solid rgba(0,0,0,0.06);text-align:right;">€${save}</td></tr>
    </table>
    <div style="margin-top:18px;text-align:center;">
      <div style="font-size:11px;color:#666;margin-bottom:8px;">Your code</div>
      <div style="display:inline-block;font-family:ui-monospace,Consolas,monospace;font-size:20px;font-weight:800;color:#B8860B;letter-spacing:0.1em;padding:12px 24px;border-radius:8px;border:1px dashed rgba(184,134,11,0.4);background:rgba(184,134,11,0.1);">${escapeHtml(code)}</div>
    </div>
