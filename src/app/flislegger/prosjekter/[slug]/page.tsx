...
export default async function FlisleggerPortfolioProjectPage({ params }: Props) {
  ...
  return (
    <div className="min-h-screen bg-[#0f1923] text-white">
      ...
      <header className="border-b border-white/10"><div className="mx-auto flex min-h-[76px] max-w-7xl items-center justify-between px-5 sm:px-8"><FlisleggerBrand /><Link href="/flislegger#kontakt" className="inline-flex min-h-11 items-center rounded-full bg-white px-5 text-sm font-semibold text-[#0f1923]">Få et tilbud</Link></div></header>
      <main>
