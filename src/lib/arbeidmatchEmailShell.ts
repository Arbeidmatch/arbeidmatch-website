...
const WORDS = {
  no: {
    ...
    ownSystem:
      "E-posten er sendt fra vårt eget system, RecOS. Ser noe feil ut i teksten eller i oppsettet, svar på denne e-posten, så retter vi det.",
  },
  en: {
    ...
    ownSystem:
      "It was sent from our own system, RecOS. If anything looks wrong in the text or in the layout, reply to this email and we will correct it.",
  },
} as const;
