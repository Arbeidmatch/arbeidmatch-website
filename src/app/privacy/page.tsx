      ...
      <div className="mx-auto w-full max-w-content px-4 md:px-6">
        <article className="mx-auto max-w-[680px] space-y-8 text-[12px] leading-[1.6] text-[#888]">
          <header className="space-y-3">
            <h1 className="font-display text-[18px] font-semibold text-[#ccc]">Privacy Policy</h1>
          ...
          <section>
            <h2 className="text-[13px] font-semibold uppercase tracking-[0.5px] text-[#aaa]">1. Who We Are</h2>
          ...
          <section>
            <h2 className="text-[13px] font-semibold uppercase tracking-[0.5px] text-[#aaa]">2. What Data We Collect and Why</h2>
            <div className="mt-4 space-y-6">
              <div>
                <h3 className="text-[12px] font-semibold uppercase tracking-[0.4px] text-[#9a9a9a]">2.1 Candidate Registration</h3>
              ...
              <div>
                <h3 className="text-[12px] font-semibold uppercase tracking-[0.4px] text-[#9a9a9a]">2.2 Employer Requests</h3>
                <ul className="mt-2 list-disc space-y-1 pl-5">
              ...
              <div>
                <h3 className="text-[12px] font-semibold uppercase tracking-[0.4px] text-[#9a9a9a]">2.3 DSB Guide Purchases</h3>
                <ul className="mt-2 list-disc space-y-1 pl-5">
              ...
              <div>
                <h3 className="text-[12px] font-semibold uppercase tracking-[0.4px] text-[#9a9a9a]">2.4 DSB Checklist Leads</h3>
                <ul className="mt-2 list-disc space-y-1 pl-5">
              ...
              <div>
                <h3 className="text-[12px] font-semibold uppercase tracking-[0.4px] text-[#9a9a9a]">2.5 DSB Waitlist</h3>
                <ul className="mt-2 list-disc space-y-1 pl-5">
              ...
              <div>
                <h3 className="text-[12px] font-semibold uppercase tracking-[0.4px] text-[#9a9a9a]">2.6 Feedback and Contact Forms</h3>
                <ul className="mt-2 list-disc space-y-1 pl-5">
              ...
              <div>
                <h3 className="text-[12px] font-semibold uppercase tracking-[0.4px] text-[#9a9a9a]">2.7 Website Usage</h3>
                <ul className="mt-2 list-disc space-y-1 pl-5">
          ...
          <section>
            <h2 className="text-[13px] font-semibold uppercase tracking-[0.5px] text-[#aaa]">3. How We Store Your Data</h2>
            <p className="mt-3 leading-relaxed">
          ...
          <section>
            <h2 className="text-[13px] font-semibold uppercase tracking-[0.5px] text-[#aaa]">4. Who We Share Data With</h2>
            <p className="mt-3 leading-relaxed">We do not sell your data. We may share data with:</p>
            <ul className="mt-2 list-disc space-y-1 pl-5">
            ...
            <p className="mt-3 leading-relaxed">All processors are GDPR compliant.</p>
          </section>

          <section>
            <h2 className="text-[13px] font-semibold uppercase tracking-[0.5px] text-[#aaa]">5. Your Rights Under GDPR</h2>
          ...
          <section>
            <h2 className="text-[13px] font-semibold uppercase tracking-[0.5px] text-[#aaa]">6. Complaints</h2>
            <p className="mt-3 leading-relaxed">
          ...
          <section>
            <h2 className="text-[13px] font-semibold uppercase tracking-[0.5px] text-[#aaa]">7. Digital Content Protection</h2>
            <p className="mt-3 leading-relaxed">
          ...
          <section>
            <h2 className="text-[13px] font-semibold uppercase tracking-[0.5px] text-[#aaa]">8. Changes to This Policy</h2>
            <p className="mt-3 leading-relaxed">
