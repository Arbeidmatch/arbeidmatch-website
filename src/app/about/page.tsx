        ...
        <section className="py-14 md:py-20">
          <div className="mx-auto max-w-content px-4 md:px-6">
            <div className="mx-auto max-w-3xl space-y-6 text-[rgba(255,255,255,0.75)] md:text-lg">
              ...
              <p>
                ArbeidMatch Norge AS was founded by a team of recruitment professionals with experience in EU/EEA
                labour mobility. We are based in Trondheim and work with businesses across Norway.
              </p>
