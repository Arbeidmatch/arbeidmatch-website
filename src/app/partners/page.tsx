...
export default function PartnersPage() {
  return (
    <div
      ...
      style={{ background: "radial-gradient(ellipse at 50% 0%, rgba(201,168,76,0.04) 0%, #0D1B2A 70%)" }}
    >
      <section className="relative px-4 py-12 md:py-20">
        ...
        <div className="relative mx-auto mt-16 grid w-full max-w-content gap-5 px-4 sm:grid-cols-2 lg:grid-cols-3 lg:gap-6 md:px-6">
          {cards.map(({ icon: Icon, title }) => (
            <article
              key={title}
              className="card-premium group relative overflow-hidden rounded-2xl border border-[rgba(201,168,76,0.2)] bg-[rgba(255,255,255,0.05)] p-6 shadow-[var(--shadow-card)] backdrop-blur-sm transition-all duration-300 ease-premium hover:border-[rgba(201,168,76,0.35)] hover:bg-[rgba(255,255,255,0.08)]"
            >
              ...
              <div className="relative flex items-start justify-between gap-3">
                ...
                <span className="badge-coming-soon rounded-full border border-[rgba(201,168,76,0.3)] bg-[rgba(201,168,76,0.15)] px-2.5 py-1 text-[10px] font-semibold uppercase tracking-wider text-[#C9A84C]">
                  Coming soon
                </span>
              </div>
              ...
              <Link
                href="/contact"
                className="relative mt-4 inline-flex text-sm font-medium text-[#C9A84C] transition-colors duration-300 hover:text-[#d8bc6a]"
              >
                Become a partner →
              </Link>
            </article>
        ...
        <div className="relative mx-auto mt-20 max-w-content rounded-2xl border border-[rgba(201,168,76,0.2)] bg-[rgba(255,255,255,0.05)] px-6 py-12 text-center md:px-12">
