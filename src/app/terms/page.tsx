    ...
    <section className="bg-[#0a0f14] py-12 md:py-20">
      <div className="mx-auto w-full max-w-content px-6 md:px-12 lg:px-20">
        <article className="mx-auto max-w-[680px] space-y-8 text-[12px] leading-[1.6] text-[rgba(255,255,255,0.82)]">
          ...
          <section>
            <h2 className="text-[13px] font-semibold uppercase tracking-[0.5px] text-[#f3f4f6]">3. Digital Guide Purchases</h2>
          ...
          <section>
            <h2 className="text-[13px] font-semibold uppercase tracking-[0.5px] text-[#f3f4f6]">4. Recruitment Services</h2>
            <div className="mt-4 space-y-6">
              <div>
