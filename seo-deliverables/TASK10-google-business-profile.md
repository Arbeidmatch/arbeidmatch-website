...
## 2) Tjenester (Service name \| Beskrivelse, maks 300 tegn hver)

1. **Bemanning bygg** \| Rekruttering av fagarbeidere til anlegg og boligprosjekter med HMS-fokus og dokumentert erfaring.
2. **Bemanning logistikk** \| Truck, lager og terminalpersonell fra EU/EØS; avklaring av sertifikater og skift før oppstart.
3. **Bemanning industri** \| Operatører, montører og tekniske assistenter til produksjon og vedlikeholdsvinduer.
4. **Rekruttering EU/EEA** \| Målrettet sourcing, intervjuer og kvalitetssikring før kandidater presenteres for arbeidsgiver.
5. **Prosjekt- og vikarbemanning** \| Fleksible team til topper og sesong, med tydelige kontraktsrammer og oppfølging.
6. **Rekruttering elektriker med DSB-støtte** \| Veiledning i dokumentasjon og prosessforståelse rundt autorisasjon (ikke juridisk rådgivning).
7. **Bemanning renhold** \| Profilert renholdspersonell til næring, bolag og borettslag med fokus på rutiner og kvalitet.
8. **Bemanning HoReCa** \| Kjøkken- og serveringshjelp til hotell og restaurant med hygienefokus og skiftplanlegging.
9. **Bemanning helse** \| Støtte ved rekruttering der autorisasjon og språk må avklares tidlig; åpenhet om krav og tidsbruk.
10. **Arbeidsgiverrådgivning** \| Praktisk støtte til innkjøp og HR om innleie, onboarding og etterlevelse i norske rammer.
...
**Spørsmål:** Hvor raskt kan dere levere folk?  
